...
//        guard let _ = (scene as? UIWindowScene) else { return }
        ...
        //Dung window.rootVC hoac dung StoryboardID de lay ra VC minh can
        guard let splitViewController = window?.rootViewController as? UISplitViewController,
            let leftNavigationController = splitViewController.viewControllers.first as? UINavigationController,
            let masterViewController = leftNavigationController.viewControllers.first as? MasterViewController,
